...
public class SfinaModalGraphMouse<V,E> extends AbstractModalGraphMouse 
	implements ModalGraphMouse, ItemSelectable {
	protected Factory<V> vertexFactory;
	protected Factory<E> edgeFactory;
	protected SfinaEditingGraphMousePlugin<V,E> editingPlugin;
	protected LabelEditingGraphMousePlugin<V,E> labelEditingPlugin;
	protected SfinaPopupGraphMousePlugin<V,E> popupEditingPlugin;
	 ...
	 *
	 */
	public SfinaModalGraphMouse(RenderContext<V,E> rc,
    ...
    protected void loadPlugins() {
		...
		editingPlugin = new SfinaEditingGraphMousePlugin(vertexFactory, edgeFactory);
		labelEditingPlugin = new LabelEditingGraphMousePlugin();
		annotatingPlugin = new AnnotatingGraphMousePlugin<V,E>(rc);
		popupEditingPlugin = new SfinaPopupGraphMousePlugin(vertexFactory, edgeFactory);
		add(scalingPlugin);
	 ...
	 */
	public SfinaEditingGraphMousePlugin getEditingPlugin() {
	 ...
	 */
	public SfinaPopupGraphMousePlugin getPopupEditingPlugin() {
