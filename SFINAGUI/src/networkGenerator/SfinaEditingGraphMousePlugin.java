...
public class SfinaEditingGraphMousePlugin<V,E> extends AbstractGraphMousePlugin implements
    ...
    public SfinaEditingGraphMousePlugin(Factory<V> vertexFactory, Factory<E> edgeFactory) {
     ...
     * @param modifiers
     */
    public SfinaEditingGraphMousePlugin(int modifiers, Factory<V> vertexFactory, Factory<E> edgeFactory) {
        super(modifiers);
