 ...
 *
 */
public class SfinaPopupGraphMousePlugin<V,E> extends AbstractPopupGraphMousePlugin {
    
    protected Factory<V> vertexFactory;
    protected Factory<E> edgeFactory;
    protected ArrayList<String> vertexFields;
    protected ArrayList<String> edgeFields;
    protected JPopupMenu popup = new JPopupMenu();

    public SfinaPopupGraphMousePlugin(Factory<V> vertexFactory, Factory<E> edgeFactory) {
